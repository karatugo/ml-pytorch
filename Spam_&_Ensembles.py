...
pred_random_forest = random_forest.predict(testing_data)

# Predict using AdaBoostClassifier on the test data
pred_ada = ada_boost.predict(testing_data)
...
print_metrics(y_test, pred_bagging, model_name="bagging")

# Print Random Forest scores
print_metrics(y_test, pred_random_forest, model_name="random forest")

# Print AdaBoost scores
print_metrics(y_test, pred_ada, model_name="ada")
